          ...
          <main className="sm:flex">
            ...
            <div className="sm:ml-6">
              <div className="sm:border-l sm:border-gray-200 sm:pl-6">
                <h1
                  className="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">{t("pageNotFound")}</h1>
                <p className="mt-1 text-base text-gray-500">{t("404message")}</p>
              </div>
              <div className="mt-10 flex space-x-3 sm:border-l sm:border-transparent sm:pl-6">
                <Link href="/">
                  <a className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium
