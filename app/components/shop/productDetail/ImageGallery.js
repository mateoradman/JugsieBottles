...
const ProductImageGallery = (props) => {
  ...
  return (
    <div className="mx-auto px-4 max-w-md lg:px-8">
      <div className="aspect-w-4 aspect-h-4 rounded-xl overflow-hidden lg:aspect-w-3 lg:aspect-h-4">
            ...
            <div className="flex flex-col-reverse z-10">
              <h2
                className={classNames(
                  ...
                  props.bottle.name === "White"
                    ? "text-personalization-dark"
                    : "text-personalization-standard"
                )}
              >
                {props.personalization.text}
              </h2>
              {Icon && (
                <Icon
                  className={classNames(
                    ...
                    props.bottle.name === "White"
                      ? "fill-personalization-dark"
                      : "fill-personalization-standard"
                  )}
                />
              )}
            </div>
