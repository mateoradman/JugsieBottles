...
export default function TechnicalSpecs() {
  ...
  return (
    <div className="bg-white">
      <div className="max-w-2xl mx-auto py-16 px-4 grid items-start grid-cols-1 gap-x-8 gap-y-16 sm:px-6 sm:py-16 lg:max-w-7xl lg:px-8 lg:grid-cols-2">
        <div>
          ...
          <dl className="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2 sm:gap-y-12 lg:gap-x-8">
