...
export default function CheckoutForm() {
    ...
    const defaultFormData = { Currency: "HRK", Source: "Website", ExternalCustomerReference: ID() };
                ...
                <div className="flex flex-col space-y-4 w-full p-2 mx-auto bg-white rounded-2xl">
                    <Disclosure defaultOpen>
                        { ({ open }) => (
                            <>
                                <Disclosure.Button
                                    className={ "flex justify-between self-center px-6 sm:px-12 py-2 text-lg sm:text-xl font-medium text-left text-green-900 bg-green-100 rounded-lg hover:bg-green-200 focus:outline-none focus-visible:ring focus-visible:ring-green-500 focus-visible:ring-opacity-75" }
                                >
                                ...
                                >
                                    <Disclosure.Panel static>
                                        <div className="flex flex-col space-y-5 text-sm card bordered rounded-lg shadow-md p-4">
                                            ...
                                            <span className="self-end sm:text-lg font-extrabold">Total price: { getFormattedPrice(getCartTotalPrice(cartItemsArray)) }</span>
                                        </div>
                                    </Disclosure.Panel>
                                </Transition>
                            </>
