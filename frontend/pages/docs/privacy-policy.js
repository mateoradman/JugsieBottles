...
export default function PrivacyPolicyPage() {
    return (
        <div className={ "container mx-auto p-10" }>
            <h1 className="text-xl font-bold">IZJAVA O PRIVATNOSTI</h1>
            <br />
            <p className="prose-sm">
                Izjava o privatnosti je sastavni dio Uvjeta poslovanja poduzeća Kožul d.o.o. te se odnosi na privatnost osobnih podataka koji se prikupljaju i koriste na stranicama www.jugsie.com.
                ...
                Na sva pitanja koja nisu posebno uređena ovom Izjavom o privatnosti uređena su Općim uvjetima korištenja Internet stranica www.jugsie.com.
            </p>
            <br />
            ...
            <p className="prose-sm">
                ...
                Ovi opći uvjeti zaštite osobnih podataka odnose se na osobne podatke koji se nalaze i koji su korištenjem internetskih stranica www.jugsie.com obrađeni, odnosno prikupljeni i pohranjeni od strane voditelja zbirke osobnih podataka, tvrtke Kožul d.o.o., sa sjedištem u Slavonskom Brodu, Vinogradska 2G, OIB: 99080771351 od Vas kao ispitanika.
                Kožul d.o.o kao pružatelj usluga internetske stranice www.jugsie.com, je predan zaštiti vaše privatnosti i vaših osobnih podataka.
                ...
                Ako imate bilo kakva pitanja u vezi zaštite osobnih podataka, molimo Vas da nas kontaktirate putem e-mail poruke na adresu info@jugsie.com.
                Pažljivo pročitajte ove opće uvjete zaštite osobnih podataka. Davanjem vaših osobnih podataka putem internetske stranice www.jugsie.com i označavanjem vašeg pristanka na ove opće uvjete putem internetske stranice www.jugsie.com, potvrđujete da ste pročitali, razumjeli i da se slažete sa ovim općim uvjetima zaštite osobnih podataka, te pristajte na prikupljanje, obradu i korištenje Vaših osobnih podataka u skladu s ovim općim uvjetima.
                Ukoliko se ne slažete s ovim općim uvjetima, napustite te ne pristupajte i ne koristite internetsku stranicu www.jugsie.com.
                Kako prikupljamo osobne podatke
                Kožul d.o.o. prikuplja Vaše osobne podatke, između ostalog, u sljedećim slučajevima:
                ...
                •    kada se uključujete u određene aktivnosti na internetskoj stranici www.jugsie.com, kao što su otvaranje korisničkog računa, ispunjavanje KOD-a ili ispunjavanje anketa, komentara, objavljivanje sadržaja i/ili objavljivanje tekstova na forumima, sudjelovanje u natjecanjima ili nagradnim igrama, slanje povratnih informacija nama, traženje informacija o našim uslugama, javljanje na oglas za posao, možemo vas zatražiti davanje određenih dodatnih osobnih podataka
            ...
            <p className="prose-sm">
                ...
                Legitimni interes:
                Ova obrada temelji se na legitimnom interesu društva Kožul d.o.o. za promoviranjem i pružanjem informacija o svojim proizvodima i uslugama, kao i u svrhu održavanja najviših standarda prodaje i usluga iz svoje ponude.
                Temeljna prava i slobode postojećih i potencijalnih kupaca odmjerena su u odnosu na interes društva Kožul d.o.o. da obrađuje osobne podatke u navedenu svrhu.
                Suglasnost:
                Društvo Kožul d.o.o koristi se direktnim marketingom temeljem Vašim osobnih podataka kako bi Vas informirali o novostima i promocijama u našoj ponudi o posebnim pogodnostima za kupnju, o prezentacijama novih proizvoda, kao i našim nastupima na sajmovima, konferencijama, te ostalim događanjima isključivo uz Vašu suglasnost.
                ...
                Obrada se temelji na obvezi društva Kožul d.o.o. da ispuni svoje zakonske obveze kao Voditelj obrade primjerice s osnova računovodstvenih i knjigovodstvenih propisa.
            </p>
            <br />
            <h2 className="font-bold text-lg">
            ...
            <br />
            <p className="prose-sm">
                Društvo Kožul d.o.o. prikuplja i koristi osobne podatke kako bi vam omogućili korištenje svojih usluga i aktivnosti putem internetske stranice www.jugsie.com, a sve kako bi unaprijedili rad internetske stranice www.jugsie.com, kako bi stvorili bazu podataka svojih korisnika, u svrhe marketinga, kako bi vas kontaktirali i dostavljali marketinške obavijesti, poboljšali naše oglašivačke i promocijske napore, analizirali uporabu internetske stranice www.jugsie.com. Također, možemo koristiti osobne podatke u statističke svrhe, zatim za rješavanje problema, provedbu administracijskih zadataka, uspostavljanje kontakta s Vama.
                Davanjem svojih osobnih podataka i prihvaćanjem ovih Općih uvjeta zaštite osobnih podataka, pristajete da vas tvrtka Kožul d.o.o. i osobe navedene u nastavku obavještavaju o promotivnim aktivnostima, proizvodima i uslugama koje nude.
                Dodatno na Vaše osobne podatke tvrtka Kožul d.o.o. može od Vas prikupljati i druge podatke koji Vas ne mogu identificirati, te se ne smatraju osobnim podacima (primjerice podatke o načinu korištenja stranica, podatke o vašem računalu, Internet provideru, Vašim preferencijama, hobijima, interesima, aktivnostima), a koje nam omogućavaju da kvalitetnije, preciznije i osobnije odabiremo podatke za korisnika, odnosno kako bi poboljšali stranice i njegove sadržaje dodatno usmjerili i prilagodili publici koja ga posjećuje. Na temelju tih podataka saznajemo koji su sadržaji najpopularniji među kojom publikom.
            </p>
            <br />
            <h2 className="font-bold text-lg">
            ...
            <p className="prose-sm">
                ...
                Ovi opći uvjeti zaštite osobnih podataka se odnose samo na uporabu i korištenje podataka koje tvrtka Kožul d.o.o. prikuplja od ispitanika. Druge internetske stranice kojima se može pristupiti putem internetske stranice www.jugsie.com imaju svoje vlastite izjave o povjerljivosti i prikupljanju podataka te načinima njihovog korištenja i objavljivanja na njima.
                Ako se prebacite na bilo koju takvu stranicu, preporučamo korisniku da pregledate izjavu o povjerljivosti podataka te stranice. Tvrtka Kožul d.o.o. nije odgovorna za načine i uvjete rada trećih strana.
                Zadržavamo pravo izmjene ove Izjave o privatnosti u bilo kojem trenutku, iz bilo kojeg razloga. O svakoj promjeni ove Izjave o privatnosti bit ćete obaviješteni na našoj web stranici. Izmjene i dopune općih uvjeta zaštite osobnih podataka stupaju na snagu odmah nakon njihove objave na internetskoj stranici www.jugsie.com.
            ...
            <p className="prose-sm">
                ...
                Ako imate ikakvih pitanja u vezi upotrebe vaših podataka, kontaktirajte nas na e-mail info@jugsie.com. Na navedenu adresu možete nas kontaktirati i u slučaju ukoliko želite ostvariti neko od svojih niže navedeni prava.
            ...
            <p className="prose-sm">
                ...
                Zaštita privatnosti vaših podataka je trajna, te društvo Kožul d.o.o. poduzima sve mjere potrebne za zaštitu istih sukladno važećoj regulativi i dobrim praksama. Osobne podatke obrađujemo na siguran način, uključujući zaštitu od neovlaštene ili nezakonite obrade te od gubitka.
                Korisnik osobnim podacima na internetskoj stranici www.jugsie.com možete pristupiti pomoću lozinke i e-mail adrese. Preporuka je da korisnik nikome ne otkriva lozinka. Uz to, korisnikove osobne identifikacijske informacije se čuvaju na serveru kojemu mogu pristupiti samo odabrane osobe i pružatelji usluga. Dužni ste brinuti se o sigurnosti Vaše korisničke lozinke i istu povremeno mijenjati.
                Niti jedan prijenos podataka preko Interneta, ili bilo koje bežične mreže ne može biti 100% siguran te tvrtka Kožul d.o.o. ne može jamčiti zaštitu bilo koje informacije prenesene na, ili s internetske stranice www.jugsie.com te nije odgovoran za radnje bilo koje treće strane kojoj takvi podaci postanu dostupni.
            </p>
        </div>
    )
}